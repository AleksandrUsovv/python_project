while True:
    user_input = input("Please choose:\n1.Print 1 for Validation ID_code and getting data \n2.Print 2 to Exit\n--> ")
    if user_input == '2':
        print('CIAO!')
        break
    elif user_input == '1':
        user_id = input('Enter your ID_Code: ')
        try:
            int(user_id)
            if len(user_id) != 11:
                raise UserWarning
            ...
            while True:
                user_input_2 = input("Please choose:\n1.Show DATA:\n"
                                  "2.Validation ID_CODE\n"
                                  "3.Exit\n--> ")
                if user_input_2 == '1':
                    if gender != 'NO DATA' and xxyy_birth != 'NO DATA' and region != 'NO DATA':
